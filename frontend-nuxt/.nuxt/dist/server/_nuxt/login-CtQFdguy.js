    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UCard, null, {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="text-center text-xs text-gray-500"${_scopeId}> Ainda não tem cadastro? `);
            ...
            return [
              createVNode("div", { class: "text-center text-xs text-gray-500" }, [
                createTextVNode(" Ainda não tem cadastro? "),
...
//# sourceMappingURL=login-CtQFdguy.js.map
