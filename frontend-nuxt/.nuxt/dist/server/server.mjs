import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, ref, isRef, computed, shallowRef, isReadonly, isShallow, isReactive, toRaw, defineAsyncComponent, defineComponent, unref, h, Suspense, nextTick, mergeProps, provide, Fragment, onServerPrefetch, createElementBlock, cloneVNode, toValue, useSSRContext, useAttrs, createVNode, resolveDynamicComponent, watch, resolveComponent, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString, watchEffect, createSlots, renderList, onErrorCaptured, createApp } from "vue";
import { $fetch as $fetch$1 } from "/home/dourado-dev/Documentos/git-projects/git-sdd/mei-finance-sdd/frontend-nuxt/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/home/dourado-dev/Documentos/git-projects/git-sdd/mei-finance-sdd/frontend-nuxt/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/home/dourado-dev/Documentos/git-projects/git-sdd/mei-finance-sdd/frontend-nuxt/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, getRequestHeader, setCookie, getCookie, deleteCookie } from "/home/dourado-dev/Documentos/git-projects/git-sdd/mei-finance-sdd/frontend-nuxt/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu, defuFn, createDefu } from "/home/dourado-dev/Documentos/git-projects/git-sdd/mei-finance-sdd/frontend-nuxt/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol, parseQuery, withTrailingSlash, withoutTrailingSlash } from "/home/dourado-dev/Documentos/git-projects/git-sdd/mei-finance-sdd/frontend-nuxt/node_modules/ufo/dist/index.mjs";
import { parse } from "/home/dourado-dev/Documentos/git-projects/git-sdd/mei-finance-sdd/frontend-nuxt/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
import destr from "/home/dourado-dev/Documentos/git-projects/git-sdd/mei-finance-sdd/frontend-nuxt/node_modules/destr/dist/index.mjs";
import { isEqual } from "/home/dourado-dev/Documentos/git-projects/git-sdd/mei-finance-sdd/frontend-nuxt/node_modules/ohash/dist/index.mjs";
import { klona } from "/home/dourado-dev/Documentos/git-projects/git-sdd/mei-finance-sdd/frontend-nuxt/node_modules/klona/dist/index.mjs";
import { createSharedComposable, useTimestamp } from "@vueuse/core";
import { extendTailwindMerge, twJoin } from "tailwind-merge";
import { useHead as useHead$1, headSymbol } from "/home/dourado-dev/Documentos/git-projects/git-sdd/mei-finance-sdd/frontend-nuxt/node_modules/@unhead/vue/dist/index.mjs";
...
import { debounce } from "/home/dourado-dev/Documentos/git-projects/git-sdd/mei-finance-sdd/frontend-nuxt/node_modules/perfect-debounce/dist/index.mjs";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index-DDYNex_n.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/login-CtQFdguy.js")
  },
  {
    name: "register",
    path: "/register",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/register-gT1er20q.js")
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import("./_nuxt/index-cSLyVDnB.js")
  },
  {
    name: "dashboard-receitas",
    path: "/dashboard/receitas",
    component: () => import("./_nuxt/index-lBF4qaSf.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-D15mJHMA.js").then((m) => m.default || m))
};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-background text-foreground font-sans antialiased" }, _attrs))}>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CqmN0QQt.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BqHGCA6J.js"));
...
export {
  ...
  useInjectButtonGroup as g,
  useToast as h,
  input as i,
  __nuxt_component_3 as j,
  getNuxtLinkProps as k,
  looseToNumber as l,
  mergeConfig as m,
  navigateTo as n,
  twMerge as t,
