import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { computed, useAttrs, toValue, getCurrentInstance, provide, inject, defineComponent, shallowRef, h, resolveComponent, ref, toRef, isRef, mergeProps, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString, createVNode, resolveDynamicComponent, watch, hasInjectionContext, unref, onServerPrefetch, nextTick, defineAsyncComponent, shallowReactive, Suspense, Fragment, createElementBlock, cloneVNode, useSSRContext, createApp, watchEffect, onErrorCaptured, reactive, effectScope, getCurrentScope, createSlots, renderList, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { s as serialize, j as defuFn, k as defu, l as hasProtocol, m as isScriptProtocol, n as joinURL, o as parseQuery, q as klona, r as createDefu, w as withQuery, t as sanitizeStatusCode, v as parseURL, e as encodePath, x as decodePath, y as getRequestHeader, z as destr, A as isEqual, B as setCookie, C as getCookie, D as deleteCookie, E as getContext, F as withTrailingSlash, G as withoutTrailingSlash, c as createError$1, $ as $fetch$1, H as baseURL, I as createHooks, J as executeAsync } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./index-DDYNex_n.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./login-CtQFdguy.mjs')
  },
  {
    name: "register",
    path: "/register",
    meta: __nuxt_page_meta || {},
    component: () => import('./register-gT1er20q.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./index-cSLyVDnB.mjs')
  },
  {
    name: "dashboard-receitas",
    path: "/dashboard/receitas",
    component: () => import('./index-lBF4qaSf.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-D15mJHMA.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CqmN0QQt.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BqHGCA6J.mjs'));
...
export { _export_sfc as _, __nuxt_component_0$2 as a, useAuth as b, __nuxt_component_4 as c, useUI as d, entry_default as default, appConfig as e, __nuxt_component_1 as f, useInjectButtonGroup as g, useToast as h, input as i, __nuxt_component_3 as j, getNuxtLinkProps as k, looseToNumber as l, mergeConfig as m, navigateTo as n, twMerge as t, useHead as u };
