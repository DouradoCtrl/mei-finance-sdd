  ...
  return (
    <button
      ...
      className={cn(
        ...
        "hover:shadow-[0_8px_25px_rgba(0,0,0,0.08)] dark:hover:shadow-[0_8px_30px_rgba(255,255,255,0.03)]"
      )}
    ...
    >
      ...
      <Moon
        className={cn(
          "h-5 w-5 text-indigo-400 absolute transition-all duration-500 transform",
